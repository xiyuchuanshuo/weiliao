...
import com.b509.xiaoliao.listener.TCPVideoReceiveListener;
...
import com.b509.xiaoliao.widget.VideoView;

/**
 * 视屏聊天
 * 
 * @author zky
 * @creation 2013年9月20日18:56:39
 */
public class VideoChat extends mActivity implements SurfaceHolder.Callback,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			voiceListener = UDPVoiceListener.getInstance(InetAddress
					.getByName(chatterIP));
			voiceListener.open();
		} catch (Exception e) {
			e.printStackTrace();
