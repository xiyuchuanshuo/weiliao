...
import com.b509.xiaoliao.wifi.GifView;
import com.b509.xiaoliao.wifi.WTAdapter;
import com.b509.xiaoliao.wifi.WTBroadcast;
import com.b509.xiaoliao.wifi.WTOperateEnum;
import com.b509.xiaoliao.wifi.WTSearchAnimationFrameLayout;
import com.b509.xiaoliao.wifi.WifiAdmin;

public class WTActivity extends mActivity implements WTBroadcast.EventHandler {
	...
	public static final String PACKAGE_NAME = "com.b509.xiaoliao";
	public static final String FIRST_OPEN_KEY = "version";
	public static final String WIFI_AP_HEADER = "weiliao_";
	public static final String WIFI_AP_PASSWORD ="weiliao509";
		...
		public void run() {
			while (true) {
				...
				if ((m_wiFiAdmin.getWifiApState() == 3)
						...
						|| (System.currentTimeMillis() - this.startTime >= 50000L)) {
	...
	class WTSearchProcess implements Runnable {
		...
		public void run() {
			while (true) {
				if (!this.running)
					return;
				if (System.currentTimeMillis() - this.startTime >= 50000L) {
