package com.b509.xiaoliao.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			UDPMessage message=myMessages.get(position);
				Bitmap bitmap;
				if(message.getDeviceCode().equals(MyApplication.mainInstance.getDeviceCode()))
					bitmap=LocalMemoryCache.getInstance().get(MainActivity.iconName);//获取自己的头像
				else
			...
			SpannableString spannableString = xiaoliaoUtil.getExpressionString(context, message.getMsg(), zhengze);
