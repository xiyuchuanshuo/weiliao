...
import com.b509.xiaoliao.inter.OnTCPReceive;
import com.b509.xiaoliao.util.Constant;

/**
 * 文件传输监听器
 * @author zky
 * @creation 2013年9月20日18:59:14
 */
public class TCPFileListener extends TCPListener  implements OnTCPReceive{
	...
	public void onReceiveData(Socket socket) throws IOException {
		...
		if(filedir.indexOf("com.ty")==-1){
			file=new File(MyApplication.mainInstance.getFilePath()+fileName);
		}else {
...
//		Log.d("==========", "接收字节："+receiveCount);
		...
		if(MyApplication.iconPath.equals(filedir)&&iconReceived!=null)
